...
#include "gun_bros_viewer/DebugKeys.h"
...
int RunViewerApplication(int argc, char **argv) {
    ...
    auto configPath = Paths::Root() / ViewerConfig::Filename;
#if GB_ENABLE_TESTS
    if (!TestOutput::directory.empty()) { configPath = TestOutput::directory / ViewerConfig::Filename; }
#endif
...
#if GB_ENABLE_TESTS
if (choice == 72) { return RunViewerSurvival(bigDirectory, "pack7", 6, 0, -1, "", 0, false, false, false, 2, 0, nullptr, false, false, nullptr, false, nullptr, true); }
#endif
...
#if GB_ENABLE_TESTS
if (choice == 50) { return RunViewerSurvival(bigDirectory, "pack2", 7, 0, -1, "", 0, false, false, false, 2, 0, nullptr, true, false, nullptr, true); }
#endif

#endif
        
#if GB_ENABLE_TESTS
if (choice == 47) { return OpenGameMenu(bigDirectory, screenshotPath, 20, false, profilePath); }
#endif
...
if (choice == 20) {
        ...
        if (choice == 21) {
            return RunViewerSurvival(bigDirectory, "pack2", 7, gunIndex, armorIndex, screenshotPath, advanceMs, firePreview, showCollisions);
        }
        
#if GB_ENABLE_TESTS
if (choice == 22) {
            return RunViewerSurvival(bigDirectory, "pack2", 7, gunIndex, armorIndex, screenshotPath, advanceMs, firePreview, showCollisions, true);
        }
#endif
...
#endif
        if (choice == 26) { return OpenGameMenu(bigDirectory, screenshotPath, menuPage, false, profilePath); }
#if GB_ENABLE_TESTS
...
#if GB_ENABLE_TESTS
if (choice == 37) { return OpenGameMenu(bigDirectory, screenshotPath, menuPage, true, profilePath); }
#endif
...
if (choice == 43) { return RunMovieStudy(bigDirectory, 0, "", 0, true); }
        ...
        if (choice == 45) { return OpenGameMenu(bigDirectory, screenshotPath, 16); }
...
#if GB_ENABLE_TESTS
if (choice == 33) { return RunViewerSurvival(bigDirectory, "pack2", 7, gunIndex, armorIndex, screenshotPath,
...
#if GB_ENABLE_TESTS
if (choice == 28) {
            return RunViewerSurvival(bigDirectory, "pack2", 7, 65, armorIndex, screenshotPath, 0,
...
if (choice == 23) {
            ...
            return RunViewerSurvival(bigDirectory, "pack2", 7, gunIndex, armorIndex, screenshotPath, advanceMs, firePreview, showCollisions, false, 2, wave - 1);
        }
#endif

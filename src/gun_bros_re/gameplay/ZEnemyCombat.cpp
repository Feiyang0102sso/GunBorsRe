...
void CEnemy::QueueBullet(const GameObjectRef &resource, int part, int node, float direction) {
    ...
    ZEnemyAction action;
    action.kind = ZEnemyAction::Kind::Bullet;
...
void CEnemy::ResolvePendingHit(bool apply) {
    ...
    ZEnemyAction action;
    action.kind = ZEnemyAction::Kind::CollisionResolved;
...
std::vector<ZEnemyAction> CEnemy::TakeActions() {
...
bool CEnemy::ResolveCombatFunction(std::uint8_t function, const std::int16_t *arguments,
    ...
    case 9:
    case 27:
        action.kind = ZEnemyAction::Kind::Effect;
        if (function == 9) {
            action.kind = ZEnemyAction::Kind::Sound;
        } else if (function == 27) {
            action.kind = ZEnemyAction::Kind::LoopSound;
        }
    ...
    case 24:
        ...
        return true;
    case 26:
        action.kind = ZEnemyAction::Kind::Broadcast;
        action.slot = args[0];
        break;
    case 28:
        action.kind = ZEnemyAction::Kind::StopSound;
        break;
    case 29:
    ...
    case 30:
        ...
        return true;
    case 31:
        action.kind = ZEnemyAction::Kind::LinkedEffect;
        action.slot = args[0];
        action.resource = ScriptResource(args[2]);
        action.node = args[1];
        break;
    case 32:
        action.kind = ZEnemyAction::Kind::StopEffect;
        action.slot = args[0];
        break;
    case 33:
    case 34:
        action.kind = ZEnemyAction::Kind::Splash;
        action.node = args[0];
    ...
    case 37:
        ...
        return true;
    case 38:
        action.kind = ZEnemyAction::Kind::Stun;
        action.node = args[0];
    ...
    case 40:
        action.kind = ZEnemyAction::Kind::Shake;
    ...
    case 45:
        ...
        return true;
    case 46:
        action.kind = ZEnemyAction::Kind::LevelEvent;
        action.slot = 1;
        break;
    case 47:
        ...
        action.kind = ZEnemyAction::Kind::Teleported;
        break;
    case 56:
    ...
    case 62:
        ...
        action.kind = ZEnemyAction::Kind::SpawnPickup;
        action.resource = ScriptResource(args[0]);
        break;
    case 57:
    ...
    case 61:
        ...
        return true;
    case 65:
        action.kind = ZEnemyAction::Kind::RemoveBullet;
        result = 1;
        break;
    case 66: {
        int amplitude = 2;
    ...
    case 71:
        ...
        action.kind = ZEnemyAction::Kind::TurretActive;

...
namespace MapDetail {
    ...
    void MapPropWorld::StartLayer(int layer) {
    ...
    bool MapPropWorld::Spawn(int layer, int objectId) {
        for (PlacedProp &prop : m_map.props) {
    ...
    void MapPropWorld::SendMessage(int objectId, int message) {
        for (PlacedProp &prop : m_map.props) {
    ...
    void MapPropWorld::Update(int deltaMs) {
    ...
    CombatTrace MapPropWorld::Trace(const CombatHit &hit, float x, float y, float dx, float dy,
    ...
    HitResult MapPropWorld::ApplyHit(CombatId target, const CombatHit &hit) {
        for (PlacedProp &prop : m_map.props) {
    ...
    void MapPropWorld::ApplyAction(PlacedProp &prop, const PropAction &action) {

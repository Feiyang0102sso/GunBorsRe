...
public:
    ...
    const Rectangle &GetPrimaryBounds() const { return m_primaryBounds; }
    const Rectangle &GetSecondaryBounds() const { return m_secondaryBounds; }
...
private:
    Rectangle m_primaryBounds;
    Rectangle m_secondaryBounds;

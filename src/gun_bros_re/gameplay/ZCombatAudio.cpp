...
void ZCombatAudio::PlayCue(const ZGunCue &cue, ZCombatId actor) {
...
void ZCombatAudio::PlayWav(std::uint32_t packHash, int ordinal, bool loop, ZCombatId actor,
                 bool moveSound) {
    CGameAssetRef wav;

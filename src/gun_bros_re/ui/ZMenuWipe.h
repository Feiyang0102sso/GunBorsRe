 ...
 */
#ifndef GUN_BROS_RE_ZMENUWIPE_H
#define GUN_BROS_RE_ZMENUWIPE_H
#include "engine/glu/movie/ZMovieRenderer.h"
class ZMenuWipe : public ZMovieRegionCallback {
public:
    bool Remember() { return m_old.CaptureFramebuffer(); }
    bool Begin(ZMovieRenderer &movies) {

...
namespace MenuDetail {
    ...
    bool ZGameMenu::DrawEquippedPlayer(CResTOCManager &toc, ZPackTables &tables, const CProfileManager &profile,
    ...
    void ZGameMenu::PlayPreviewSounds(const std::vector<ZMoveSoundRef> &sounds) {

...
class Planet {
public:
    static const Planet *Load(CResTOCManager &toc, CGunBros &tables, const GameObjectRef &ref);
    static bool LoadSurvivalLevels(CResTOCManager &toc, CGunBros &tables, std::map<unsigned, GameObjectRef> &levels);

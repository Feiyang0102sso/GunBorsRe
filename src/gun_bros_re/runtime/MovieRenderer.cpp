...
bool MovieRenderer::Init(CResPackTOC &pack, CResPackTOC &core) {
    ...
    if (!m_sprites.Init(pack) ||
        !m_program.Load(ASSET_ROOT "/src/gun_bros_re/shaders", "ogles_vs_mvp_tex0", "ogles_ps_tex0") ||
        !m_colorProgram.Load(ASSET_ROOT "/src/gun_bros_re/shaders", "ogles_vs_mvp_constcolor", "ogles_ps_constcolor") ||

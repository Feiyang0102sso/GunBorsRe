 ...
 */
#ifndef GUN_BROS_RE_ORIGINALDIALOGPOPUP_H
#define GUN_BROS_RE_ORIGINALDIALOGPOPUP_H
#include "runtime/OriginalTextLayout.h"

class CDialogPopup : public IMovieRegionCallback {
public:
    bool Show(MovieRenderer &renderer, const std::string &text, bool automatic, unsigned arrow) {
        ...
        m_lines = FormatStoreText(renderer, text, region.width, {0, 0, 0, 0, 0});
        m_pages.clear();
        Page page;
...
private:
    ...
    std::vector<StoreTextLine> m_lines;

...
#ifndef GUN_BROS_RE_ENGINE_ZMARKERBATCH_H
#define GUN_BROS_RE_ENGINE_ZMARKERBATCH_H
...
public:
    ...
    ZMarkerBatch(const ZMarkerBatch &) = delete;
    ZMarkerBatch &operator=(const ZMarkerBatch &) = delete;
    ...
    void Draw(const ZShaderProgram &program, const float *mvp, float red,

 ...
 * plain files under assets/shaders/ so they can be edited without a
 * rebuild. That is a development convenience, not a design decision -- see the
 * asset-path note in PLAN.md.
 */

#ifndef GUN_BROS_RE_ENGINE_ZSHADERPROGRAM_H
#define GUN_BROS_RE_ENGINE_ZSHADERPROGRAM_H
...
public:
    ...
    ZShaderProgram &operator=(const ZShaderProgram &) = delete;

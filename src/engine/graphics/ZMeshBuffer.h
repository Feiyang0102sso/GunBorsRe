...
#ifndef GUN_BROS_RE_ENGINE_ZMESHBUFFER_H
#define GUN_BROS_RE_ENGINE_ZMESHBUFFER_H
...
public:
    ...
    ZMeshBuffer(const ZMeshBuffer &) = delete;
    ZMeshBuffer &operator=(const ZMeshBuffer &) = delete;
     ...
     */
    void Draw(const ZShaderProgram &program, const float *mvp,
              const ZTexture &texture, float heatIntensity = 0.0f,

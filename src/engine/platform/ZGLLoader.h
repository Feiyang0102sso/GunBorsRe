...
#ifndef GUN_BROS_RE_ENGINE_PLATFORM_ZGLLOADER_H
#define GUN_BROS_RE_ENGINE_PLATFORM_ZGLLOADER_H

// Windows min/max macros must not leak into C++ resource and gameplay headers.
#ifndef NOMINMAX
#define NOMINMAX
#endif
#include <windows.h>

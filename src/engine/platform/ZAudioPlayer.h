...
#ifndef GUN_BROS_RE_ENGINE_ZAUDIOPLAYER_H
#define GUN_BROS_RE_ENGINE_ZAUDIOPLAYER_H
...
public:
    ...
    ZAudioPlayer(const ZAudioPlayer &) = delete;
    ZAudioPlayer &operator=(const ZAudioPlayer &) = delete;
    ...
    ZAudioPlaybackState GetPlaybackState() const;

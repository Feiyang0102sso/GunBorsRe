...
#ifndef GUN_BROS_RE_ENGINE_PLATFORM_ZWINDOW_H
#define GUN_BROS_RE_ENGINE_PLATFORM_ZWINDOW_H
...
public:
    ...
    void SetPresentationOverlay(std::unique_ptr<ZWindowOverlay> overlay);
    ...
    bool IsKeyDown(ZKeyCode key) const;
...
private:
    std::unique_ptr<ZWindowOverlay> m_presentationOverlay;
    SDL_Window *m_window;
    ...
    float m_wheelDelta;
    struct KeyPress { ZKeyCode code; bool shift; };
    ...
    bool m_keyDown[static_cast<int>(ZKeyCode::Count)];
};

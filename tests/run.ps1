...
foreach ($suite in ($Phase | Select-Object -Unique)) {
    if ($suite -eq 'Core') {
        Add-Check 'host-settings' @('--host-settings-check')
        ...
        Add-Check 'deathmatch-data' @('--deathmatch-data-check')
        Add-Check 'deathmatch' @('--deathmatch-check')
        Add-Check 'deathmatch-feedback' @('--deathmatch-feedback-check')
